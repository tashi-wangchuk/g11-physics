...
\newtcolorbox{supplementary}[1]{
  ...
  colframe = black!40,
  fonttitle = \bfseries,
  title    = {Supplementary --- #1 \ {\normalfont\footnotesize\itshape (optional --- read for pleasure, skip without loss)}},
  sharp corners,
  boxrule  = 0.5pt,
  left=8pt, right=8pt, top=6pt, bottom=6pt,
  before upper={\setlength{\parskip}{4pt}},
...
\newtcolorbox{whiteboard}[1][]{
  ...
  colframe = black!55,
  fonttitle = \bfseries,
  title    = {Whiteboard Challenge~#1 \ {\normalfont\footnotesize\itshape (stand up, groups of three, one marker each)}},
  sharp corners,
  boxrule  = 1pt,
  left=8pt, right=8pt, top=6pt, bottom=6pt,
  before upper={\setlength{\parskip}{4pt}},
